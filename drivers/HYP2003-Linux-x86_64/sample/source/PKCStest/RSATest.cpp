...
void RSATest::RsaKeyGenerationTest(void)
{
	...
	CK_MECHANISM ckMechanism_rsa = {CKM_RSA_PKCS, NULL_PTR, 0};
	CK_MECHANISM ckMechanism = {CKM_SHA512_RSA_PKCS, NULL_PTR, 0};
//	CK_BYTE pbMsg[] = "UsbToken RunRsaKeyGenerationTest...";
//	CK_ULONG ulMsgLen = strlen((const char *)pbMsg);
	CK_BYTE pbMsg[1920] = { 0 };
	CK_ULONG ulMsgLen = sizeof(pbMsg);
